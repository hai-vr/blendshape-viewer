...
namespace Hai.VisualExpressionsEditor.Scripts.Editor
{
    public class VisualExpressionsEditorGeneratorSingular
    {
        ...
        private VisualExpressionsEditorDiffCompute _diffCompute;

        public void Begin(GameObject objectToAnimate, float overlay, bool useComputeShader)
        {
            _objectToAnimate = objectToAnimate;
            _overlay = overlay;
            _useComputeShader = SystemInfo.supportsComputeShaders && useComputeShader;

            _material = new Material(_useComputeShader ? Shader.Find("Hai/VisualExpressionsEditorRectOnly") : Shader.Find("Hai/VisualExpressionsEditor"));
            ...
            {
                _diffCompute = new VisualExpressionsEditorDiffCompute();
            }
        }
        ...
        public void Render(AnimationClip clip, Texture2D element)
        {
            try
            {
                ...
                AnimationMode.SampleAnimationClip(_objectToAnimate.gameObject, clip, 1 / 60f);
